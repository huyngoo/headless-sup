...
export default class Common {
  ...
  getSizedProducts = () => new SizedProducts();
}

class SizedProducts extends UIComponent {
  selector = $("#container");

  /**
   * @returns {ProductGrid}
   */
  getProductGrid = () => new ProductGrid();
}

class ProductGrid extends UIComponent {
  selector = $("container");

  // get links of each product
  links = this.selector.$$("article > .inner-article > h1 > a");
}
